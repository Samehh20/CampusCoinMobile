...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> _makePostRequest( String user, String pass) async {
    String url = "http://192.168.1.3:5000/mobileAPIauth"; // Replace with your API URL
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      padding: EdgeInsets.all(20.0),
        ...
        Container(
          margin: EdgeInsets.symmetric(horizontal: 20.0),
          child: TextFormField(decoration: InputDecoration(hintText: ' pass ' , labelText: 'pass: ' ,border: OutlineInputBorder(),prefixIcon:Icon(Icons.lock),suffixIcon:Icon(Icons.remove_red_eye) ,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Text('you have: $_responseData',style: TextStyle(color: Colors.black,fontSize: 25.0,fontWeight: FontWeight.bold ),),
                    ),
                  ),
                  Container(
                    padding: EdgeInsets.fromLTRB(40.0, 10.0, 40.0, 85.0),
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Column(
                                    children: [
                                      Text("Name:"+item[3], style: TextStyle(color: Colors.black,fontSize: 15.0,fontWeight: FontWeight.bold )),
                                      Text("Email:"+item[2], style: TextStyle(color: Colors.black,fontSize: 15.0,fontWeight: FontWeight.bold )),
                                      Text("Password:"+item[4], style: TextStyle(color: Colors.black,fontSize: 15.0,fontWeight: FontWeight.bold )),
                                      Text("Value:"+item[5].toString(), style: TextStyle(color: Colors.black,fontSize: 15.0,fontWeight: FontWeight.bold )),
                                    ],
                                  )),
                                  Expanded(
                                    child: Column(
                        ...
                        child: Padding(
                          ...
                          child: Center(
                            child: ListView(
                                        ...
                                        children: [Center(child: Text('Transaction')),
                                          Table(
                                            ...
                                            children: [
                                              ...
                                              TableRow(
                                                children: [
                                                  ...
                                                  TableCell(child: Text('Card Number')),
                                              ...
                                              for (var item in dataList)
                                                TableRow(
                                                  children: [
                                                    TableCell(child: Text(item[1])), // Access data by key
                                                    TableCell(child: Text(item[2])),
                                                    TableCell(child: Text(item[3].toString())),
                                                    TableCell(child: Text(item[6].toString())),
                                                    TableCell(child: Text(item[8].toString())),
                                                  ],
                                                ),
                                            ],
                                          ),
              ...
              children: items.map((item) => Container(
                ...
                child: Column(
                  children: [
                    Text("from:"+item[1]),
                    Text("to:"+item[2]),
                    Text("value:"+item[6].toString()),
                    Text("time:"+item[8].toString()),
                  ],
                ),
              )).toList(),
            ),
